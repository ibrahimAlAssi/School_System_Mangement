                                            ...
                                            @foreach($Student->images as $attachment)
                                                <tr style='text-align:center;vertical-align:middle'>
                                                    ...
                                                    <td colspan="2">
                                                        ...
                                                        <a class="btn btn-outline-warning btn-sm" href="{{url('Show_Attachement')}}/{{ $attachment->imageable->name}}/{{$attachment->filename}}"><i style="color: #ffc107" class="far fa-eye "></i>&nbsp; {{ __('main_trans.showAttachement')  }}</a>
                                                    </td>
                                                </tr>
